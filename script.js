...
function showOverlayAndRedirect() {
    ...
    setTimeout(() => { window.location.href = '舒尔特方格.html'; }, 1000);
}
...
(function () {
    ...
    g.Group.prototype.each = function (action, asc) {
        var asc = asc || 0, i;
        if (asc) {
            for (i = 0; i < this.length; i++) this.collection[i][action](i);
        } else {
            i = this.length;
            ...
            if (
                ...
                if (gameMode === 'challenge') {
                    if (this.updateTickMax - this.updateTickChange > this.updateTickLimit) {
                        this.updateTickMax -= this.updateTickChange * 2;
                    }
                }
...
(function () {
	...
	["up", "down", "right", "left"].forEach(function(dir) {
		StatePlay.prototype[dir + "On"] = function () {
			g.currentState().keys[dir] = 1;
		};
		StatePlay.prototype[dir + "Off"] = function () {
			g.currentState().keys[dir] = 0;
		};
	});
	...
	StatePlay.prototype.keydown = function (e) {
		...
		const _this = g.currentState();
		switch (code) {
			case 38: case 87: _this.upOn(); break;
			case 39: case 68: _this.rightOn(); break;
			case 40: case 83: _this.downOn(); break;
			case 37: case 65: _this.leftOn(); break;
		}
	};
